    ...
    return (
        <div className="screen active" id="screen-question" style={{ display: 'flex', flexDirection: 'column', height: '100%', paddingTop: '10px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px', gap: '15px' }}>
                ...
                <div>
                    <h3 style={{ fontSize: '1.2rem', color: 'var(--text-primary)', fontWeight: 900, textTransform: 'uppercase', margin: 0 }}>Tu Pregunta</h3>
            ...
            <div className="card" style={{
                ...
                <div style={{ position: 'relative', flex: 1, display: 'flex', flexDirection: 'column' }}>
                    <textarea
                        ...
                        placeholder="Escribe aquí tu pregunta para Sergio Fajardo..."
                        value={questionText}
